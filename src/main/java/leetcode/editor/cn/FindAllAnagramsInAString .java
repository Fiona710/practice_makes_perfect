...
// 
//
// Related Topics 哈希表 字符串 滑动窗口 👍 1946 👎 0
...
//
//        char[] pchars = new char[plen];
//        for(int i = 0;i < plen;i++){
//            pchars[i] = p.charAt(i);
//        }
//        Arrays.sort(pchars);
//        String pSort = new String(pchars);
//
//        for(;left < slen - plen + 1;left++){
//            char[] chars = new char[plen];
//            for(int right = left;right < left + plen ;right++){
//                int index = right - left;
//                chars[index] = s.charAt(right);
//            }
//            Arrays.sort(chars);
//            String tmpStr = new String(chars);
//            if(pSort.equals(tmpStr)){
//                ans.add(left);
//            }
//        }
//        return ans;
